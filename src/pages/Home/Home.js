        ...
        {isLoading ? (
          ...
          <TableContainer component={Paper}>
            <Table>
              <TableHead>
                <TableRow>
                  <TableCell className="tableHeaderCell" onClick={() => requestSort('productName')}>Produktname{getSortIcon('productName')}</TableCell>
                  <TableCell className="tableHeaderCell" onClick={() => requestSort('energie')}>Energie{getSortIcon('energie')}</TableCell>
                  <TableCell className="tableHeaderCell" onClick={() => requestSort('fett')}>Fett{getSortIcon('fett')}</TableCell>
                  <TableCell className="tableHeaderCell" onClick={() => requestSort('gesättigteFettsäuren')}>Gesättigte Fettsäuren{getSortIcon('gesättigteFettsäuren')}</TableCell>
                  <TableCell className="tableHeaderCell" onClick={() => requestSort('kohlenhydrate')}>Kohlenhydrate{getSortIcon('kohlenhydrate')}</TableCell>
                  <TableCell className="tableHeaderCell" onClick={() => requestSort('zucker')}>Zucker{getSortIcon('zucker')}</TableCell>
                  <TableCell className="tableHeaderCell" onClick={() => requestSort('ballaststoffe')}>Ballaststoffe{getSortIcon('ballaststoffe')}</TableCell>
                  <TableCell className="tableHeaderCell" onClick={() => requestSort('eiweiß')}>Eiweiß{getSortIcon('eiweiß')}</TableCell>
                  <TableCell className="tableHeaderCell" onClick={() => requestSort('salz')}>Salz{getSortIcon('salz')}</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
